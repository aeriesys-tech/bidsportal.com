<template>
    <div :class="[isOpen ? 'search search-open' : 'search']" class="dropdown-container">
        <div class="search-inner">
            <input class="form-control form-control-sm search-selected" ref="toggle" :tabindex="tabindex"
            ...
            <transition name="fade" mode="out-in">
                <div class="search-dropdown" v-if="isOpen">
                    <div class="search-input_wrap">
                        ...
                        <input type="text" class="form-control form-control-sm search-input" autocomplete="off"
                    ...
                    <table class="table table-responsive-sm table-bordered table-striped table-sm search-list"
                        ...
                        <tbody>
                            <tr class="search-item" v-for="(result, index) in results"
