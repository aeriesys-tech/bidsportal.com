                        ...
                        <div class="table-responsive table-responsive-sm">
                            <table class="table table-striped table-sm text-wrap table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="award_type, key in awards" :key="key">
                                        <td class="text-center">{{ meta.from + key }}</td>
                                        <td>{{award_type.award_type_name}}</td>
                                        <td>{{award_type.sort}}</td>
                                        <td class="text-center">
                                            <a href="javascript:void(0)" class="text-success me-2" @click="editAward(award_type)"><i class="ri-pencil-line fs-18 lh-1"></i></a>
                                            <a href="javascript:void(0)" class="text-danger" @click="deleteAward(award_type)"><i class="ri-delete-bin-6-line fs-18 lh-1"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
