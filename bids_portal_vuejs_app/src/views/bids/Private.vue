    ...
    <div class="regions">
        <div class="container-fluid justify-content-center pt-3">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li class="nav-item">
                    <router-link to="/bids/private-commercial" class="nav-link active">
                        <img class="icon" src="@/assets/icons/privateblue.svg" alt="icon" />
                        Private / Commercial
                    </router-link>
                </li>
                <li class="nav-item">
                ...
                <div class="col-md-5 my-auto text-end text-sm-end">
                    <ul class="list-inline hstack flex-wrap gap-4 mb-0 s-dropdown dropdown" style="float: right;">
                        <li class="list-inline-item mb-0" v-if="tags.length !==0">
                            <a href="javascript:void(0)" style="color: #747579;" @click.prevent="showModal()"><i class="fa fa-save fa-fw fs-6 me-1 text-primary"></i>Save Search</a>
                        </li>
            ...
            <div class="row g-2 g-lg-4">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="categorys">
                                    ...
                                    <div class="scroll1">
                                        <div class="d-flex justify-content-between align-items-center" v-for="category in  categorys " :key="category.category_id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" :value="category.category_id" v-model="selectedcategory" @change="updateCheckallCategory(category)" />
                                                <label class="form-check-label" for="presoliciation"> {{ category.category_name }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="Private">
                                    ...
                                    <div class="scroll1">
                                        <div class="d-flex justify-content-between align-items-center" v-for="statefederal in  agencyState " :key="statefederal.id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" :id="statefederal.id + 'statefederal'" :value="statefederal.agency_name" v-model="selectedState" @change="updateCheckallState(statefederal)" />
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="vl-parent">
                        ...
                        <section v-if="PrivateOppotunities.length === 0">
                            <div class="container">
                        ...
                        <div class="text-end" v-if="PrivateOppotunities.length !== 0">
                        ...
                        <div v-if="PrivateOppotunities.length !== 0">
                            <div v-if="listview">
                                <div class="card shadow mb-2" v-for="privateOppotunitie in PrivateOppotunities" :key="privateOppotunitie.tdr_id">
                                    <div class="card-body py-md-2 d-flex flex-column h-100 position-relative" id="hovershadow">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <strong class="card-title mb-1">
                                                <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                    <a href="javascript:void(0)" @click="bidsdetails(privateOppotunitie)" style="text-transform: uppercase;"><div v-html="highlight(privateOppotunitie.tdr_title)"></div></a>
                                                </div>
                                                <div v-else>
                                                    <a href="javascript:void(0)" @click="showModal()">
                                                        <div v-html="highlight(privateOppotunitie.tdr_title)"></div>
                                                    </a>
                                                </div>
                                            </strong>
                                            <ul class="list-inline mb-0 z-index-2">
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="form-check-inline mb-0" v-if="$store.getters.user !== null">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" :value="privateOppotunitie.tdr_id" id="flexCheckChecked" v-model="sendMails.bids" />
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        <ul class="nav nav-divider mt-3" style="color: #646c9a;">
                                            <li class="nav-item"><img class="small w-15px me-1" src="../../assets/icons/posteddate.svg" />{{ privateOppotunitie.notice.notice_type }}</li>
                                            <li class="nav-item"><img class="small w-15px me-1" src="../../assets/icons/bidnumber.svg" />{{ privateOppotunitie.tdr_no }}</li>
                                            <li class="nav-item">
                                                <img class="small w-15px me-1" src="../../assets/icons/posteddate.svg" /> {{ dateFormat(privateOppotunitie.tdr_posted_date) }} &nbsp;<span> {{ privateOppotunitie.created_at }} </span>
                                            </li>
                                            <li class="nav-item">
                                                <img class="small w-15px me-1" src="../../assets/icons/duedate.svg" /> {{ dateFormat(privateOppotunitie.tdr_expiry_date) }}
                                                <span class="col-green" v-if="datecalcu(privateOppotunitie.tdr_expiry_date,currentDate()) > 1">
                                                    &nbsp; {{ datecalcu( privateOppotunitie.tdr_expiry_date, currentDate() ) }} Day to Go
                                                </span>
                                        ...
                                        <ul class="list-group list-group-borderless small mb-0 mt-2">
                                            <li class="list-group-item d-flex text-success p-0">
                                                ...
                                                <p class="limited-text" style="color: #595d6e; text-align: justify;" v-html="privateOppotunitie.tdr_desc"></p>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="border-top d-sm-flex justify-content-sm-between align-items-center mt-3 mt-md-auto">
											...
											<span class="mb-0 me-2">/day</span> -->
                                                <ul class="nav nav-divider small mt-3" style="color: #595d6e;">
                                                    <li class="nav-item text-primary"><i class="bi bi-patch-check-fill text-primary me-2"></i>{{privateOppotunitie.tdr_agency}}</li>
                                                    <!-- <li class="nav-item text-primary">Subscribe Now ! To view agency</li> -->
                                                    <li class="nav-item">
                                                        <i class="bi bi-geo-alt-fill text-primary me-2"></i> {{ privateOppotunitie?.state?.state_name }}<span v-if="privateOppotunitie?.state?.state_name">,</span> {{
                                                        privateOppotunitie.country.country_name }}
                                                    </li>
                                                </ul>
                                            </div>
                                            <!-- Price -->
                                            <div class="mt-3">
                                                ...
                                                <ul class="list-inline mb-0 z-index-2 small">
                                                    <!-- Heart icon -->
                                                    <li class="list-inline-item" v-if="$store.getters.user !== null">
                                                        <a href="javascript:void(0)" class="p-2" @click.prevent="shareBidPrivate(privateOppotunitie)" v-modal="shareBid.bids"><i class="fa-solid fa-fw fa-share-alt"></i>SHARE</a>
                                                    </li>
                                                    <!-- Share icon -->
                                                    <li class="list-inline-item" v-if="checkCartItem(privateOppotunitie.tdr_id)">
                                                        <!-- Share button -->
                                                        <div v-if="$store.getters.user?.subscription_id ===0">
                                                            <a href="javascript:void(0)" @click="addCart(privateOppotunitie)" class="p-2">
                            ...
                            <div v-else>
                                <div class="card shadow" v-if="PrivateOppotunities.length !== 0">
                                    <div class="card-body py-md-2 d-flex flex-column h-100 position-relative">
                                        <div class="table-responsive border-0">
                                            <table class="table table-sm small align-middle p-4 mb-0 table-hover table-shrink">
                                                ...
                                                <!-- Table body START -->
                                                <tbody class="border-top-0" v-for="privateOppotunitie in PrivateOppotunities" :key="privateOppotunitie.tdr_id">
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="form-check my-auto" v-if="$store.getters.user !== null">
                                                                    <input class="form-check-input me-3" type="checkbox" :value="privateOppotunitie.tdr_id" v-model="sendMails.bids" />
                                                                ...
                                                                <div class="row">
                                                                    <div class="column">
                                                                        <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                                            <a href="javascript:void(0)" @click="bidsdetails(privateOppotunitie)">{{ privateOppotunitie.tdr_no }}</a>
                                                                        </div>
                                                                        <div v-else>{{ privateOppotunitie.tdr_no }}</div>
                                                                    </div>

                                                                    <div class="column">
                                                                        <a :style="{color:privateOppotunitie.notice.backround_color}" class="badge bg-success bg-opacity-10">{{ privateOppotunitie.notice.notice_type }}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td><div v-html="highlight(privateOppotunitie.tdr_title)"></div></td>
                                                        <td>{{ privateOppotunitie.tdr_agency }}</td>
                                                        <td>{{ privateOppotunitie.state?.state_code }},{{ privateOppotunitie?.state?.state_name }}</td>
                                                        <td style="width: 110px;">{{ privateOppotunitie.tdr_expiry_date }}</td>
                                                        <td>
                                                            <span v-if="checkCartItem(privateOppotunitie.tdr_id)">
                                                                <div v-if="$store.getters.user?.subscription_id ===0">
                                                                    <a href="javascript:void(0)" @click="addCart(privateOppotunitie)"><img v-if="hidecartstatue" class="mb-1 me-2" src="@/assets/icons/addcart.svg" width="20" /></a>
                                                                </div>
                                                            </span>
                                                            <span v-else>
                                                                <img src="assets/images/icons/cart-24.svg" width="19" />
                        ...
                        <!-- <div class="kt-portlet mb-0" v-if="PrivateOppotunities.length !== 0">
                        ...
                        <div v-if="PrivateOppotunities.length !== 0">
                            <div style="float: left;">
                                <input type="text" class="form-control" v-model="meta.currentPage" @keypress.enter="getPrivate()" style="width: 60px;" />
                            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addCart(privateOppotunitie) {
                let vm = this;
                vm.$store.commit("addTocart", privateOppotunitie);
                vm.getPrivate();
            },
            ...
            getPrivate() {
                ...
                let uri = "searchBidsForPrivateOrCommercial?page=" + vm.meta.currentPage + "&search=" + vm.meta.search + "&order_by=" + vm.meta.order_by + "&field=" + vm.meta.field + "&per_page=" + vm.meta.per_page;
                // vm.isLoading = true
                vm.isLoading = true;
                vm.$store
                    ...
                    .then(function (response) {
                        vm.isLoading = false;
                        vm.PrivateOppotunities = response.data.data;
            ...
            SaveStatusactive(active) {
                ...
                if (i !== -1) {
                    ...
                    // this.filters = this.filters.filter((Active,index) => this.filters.indexOf(Active) === index);
            ...
            login() {
                ...
                vm.$store
                    ...
                    .then(function (response) {
                        ...
                        vm.$router.push("/bids/private-commercial");
                        vm.userlogin = false;
                        vm.errors = [];
                    })
                    .catch(function (error) {
