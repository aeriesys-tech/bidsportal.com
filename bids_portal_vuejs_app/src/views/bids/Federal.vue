<template>
                ...
                <div class="col-md-5 my-auto">
                    <ul class="list-inline hstack flex-wrap gap-4 mb-0 s-dropdown dropdown my-auto" style="float: right;">
                        ...
                        <li class="cursor list-inline-item mb-0">
                            <a href="javascript:void(0)" style="color: #747579;" data-bs-toggle="modal"><i class="fa fa-bell fa-fw fs-6 text-dark me-1"></i>Set Alert</a>
                        </li>
                        ...
                        <li class="list-inline-item mb-0">
                            <a href=""> <i :class="{ gridblockcolor: gridview }" class="fa fa-th-large me-3"></i></a>
                            <a href="" ><i :class="{ gridblockcolor: listview }" class="fa fa-bars text-gray me-1"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <form class="rounded-3 shadow" id="federal">
                            ...
                            <div class="card card-body rounded-0 p-2">
                                <div class="ml2 d-flex btn-more d-flex justify-content-between align-items-center" href="" role="button" aria-expanded="false" aria-controls="notice">
                                    <h6 style="font-size: 15px; font-weight: normal;" class="mb-2" :class="{'bluetextclass': meta.naics?.length !==0}">Primary NAICS Code</h6>
                            ...
                            <div class="card card-body rounded-0 p-2">
                                <div class="ml2 d-flex btn-more d-flex justify-content-between align-items-center" href="" role="button" aria-expanded="false" aria-controls="notice">
                                    <h6 style="font-size: 15px; font-weight: normal;" class="mb-2" :class="{'bluetextclass': meta.pscs?.length !==0}">Product & Service Code</h6>
                            ...
                            <div class="card card-body rounded-0 p-2">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#setaside" role="button" aria-expanded="false" aria-controls="notice">
                                    <h6 style="font-size: 15px; font-weight: normal;" class="mb-2" :class="{'bluetextclass': meta.set_asides?.length !==0}">Competition(Set-Aside)</h6>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <strong class="card-title mb-1">
                                                <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                    <a href="javascript:void(0)" @click="tenderDetails(federal_tender)" style="text-transform: uppercase;"><div v-html="highlight(federal_tender.title)"></div></a>
                                                </div>
                                                <div v-else>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="column">
                                                                        <a :style="{color:federal_tender.notice.backround_color}" class="badge bg-success bg-opacity-10">{{ federal_tender.federal_notice.notice_name }}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td><div v-html="highlight(federal_tender.title)"></div></td>
                                                        <td>{{ federal_tender.tdr_agency }}</td>
                                                        <td>{{ federal_tender.place_of_performance }}</td>
                                                        <td style="width: 110px;">{{ federal_tender.tdr_expiry_date }}</td>
                                                        <td>
            ...
            <div class="">
                <div class="">
                    ...
                    <div class="">
                        ...
                        <SaveSearch @closeModal="closeModal" @savedSearch="saveSearch" @updateSearch="addFederalFilter" :status="status" :alert_label="meta.alert_label" :savedbids="savedbids" ref="save_search" v-if="save_search" />
                    </div>
                </div>
    ...
    <teleport to="#modals" v-if="add_federal_filters">
        <div class="modal-overlay">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header m-header"></div>
    ...
    export default {
        ...
        methods: {
            ...
            tenderDetails(federal_tender){
                ...
                this.$router.push("/bids/" + "federal-opportunities" + "/" + federal_tender.title.replace(/\//g, "") + "-" + federal_tender.tender_no);
            },
