...
class FederalAttachmentResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        if(isset($this->attachment_s3_url)){
        	$download_url = $this->attachment_s3_url;
        } else if (isset($this->attachment_url)){
