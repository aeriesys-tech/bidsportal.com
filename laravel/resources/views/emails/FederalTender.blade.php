                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding: 0px 0px 0px; text-align: left;">
                                                                <a href="https://bidsportal.com/#/bids/federal-opportunities" target="_blank" style="padding: 2px; color: #fff; background: #21e040; font-size: 12px; border: 1px solid #21e040; border-radius: 5px; padding: 5px;">
                                                                    View All
                                                                </a>
                                                            </td>
                                                                        ...
                                                                        <tr style="padding-bottom: 10px;">
                                                                            <td colspan="4">
                                                                                <b style="color: #99cc00; font-size: 16px; font-family: sans-serif;">
                                                                                    <a href="https://bidsportal.com/#/bids/federal-opportunities" style="color: #02c459;" target="_blank">
                                                                            ...
                                                                            <td style="width: 23%;">
                                                                                <span style="font-family: sans-serif; font-size: 13px;">
                                                                                    ...
                                                                                    <span style="color: #3997ff;">
                                                                                        <a target="_blank" href="https://bidsportal.com/downloadStateAttachments/{{ $bid->federal_tender_id }}">
