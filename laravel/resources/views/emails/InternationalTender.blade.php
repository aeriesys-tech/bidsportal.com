                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding: 0px 0px 0px; text-align: left;">
                                                                <a href="https://bidsportal.com/#/bids/international-opportunities" target="_blank" style="padding: 2px; color: #fff; background: #21e040; font-size: 12px; border: 1px solid #21e040; border-radius: 5px; padding: 5px;">
                                                                    View All
                                                                </a>
                                                            </td>
                                                            <td style="padding: 0px 0px 0px; font-family: arial; font-size: 12px; text-align: right; line-height: 1.5; color: #000;" align="center">
                                                                ...
                                                                <img src="https://bidsportal.com/images/mail_png.png" class="imgcol" style="width: 15px;">&nbsp; support@bidsportal.com
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            >
                                                <table style="height: 146px; margin-top: -18px;" width="600" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                        ...
                                                        @foreach($bids as $bid)
                                                            @php $bid_details = $bid->InternationalTenderDetails() @endphp
                                                            <tr>
                                                                        ...
                                                                        <tr style="padding-bottom: 10px;">
                                                                            <td colspan="4">
                                                                                <b style="color: #99cc00; font-size: 16px; font-family: sans-serif;">
                                                                                    <a href="https://bidsportal.com/#/bids/international-opportunities" style="color: #02c459;" target="_blank">
                                                                            ...
                                                                            <td style="width: 23%;">
                                                                                <span style="font-family: sans-serif; font-size: 13px;">
                                                                                    ...
                                                                                    <span style="color: #3997ff;">
                                                                                        <a target="_blank" href="https://bidsportal.com/downloadStateAttachments/{{ $bid->international_tender_id }}">
