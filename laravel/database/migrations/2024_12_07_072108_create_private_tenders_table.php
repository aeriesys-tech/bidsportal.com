...
return new class extends Migration
{
    ...
    {
        Schema::create('private_tenders', function (Blueprint $table) {
            $table->bigIncrements('private_tender_id');
    ...
    {
        Schema::dropIfExists('private_tenders');
    }
};
