...
return new class extends Migration
{
    ...
    {
        Schema::create('international_filters', function (Blueprint $table) {
            $table->id('international_filter_id');
            $table->string('international_filter_name', 50);
    ...
    {
        Schema::dropIfExists('international_filters');
    }
};
