...
return new class extends Migration
{
    ...
    {
        Schema::create('international_filter_states', function (Blueprint $table) {
            $table->id('international_filter_state_id');
    ...
    {
        Schema::dropIfExists('international_filter_states');
    }
};
