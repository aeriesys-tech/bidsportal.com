                                ...
                                <span class="">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-sm btn-primary" @click="backSaveAlert()"
                                        style="padding: 5px; font-weight: 400;">Back</a> -->
                                            ...
                                            <a href="javascript:void(0)" class="btn fw-400 btn-sm btn-success me-2" @click="backSaveAlert()"
                                       >Back</a>
                                          <router-link to="/bids/state-opportunities" class="btn fw-400 btn-sm btn-outline-secondary "
                                       >Back To Bids</router-link>
                                ...
                                <form class="row g-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="row g-2 text-align-justify">
                                            <div class="col-sm-6 col-lg-6 col-xl-6" style="padding-right: 20px;" v-for="set_aside in set_asides"
                                                            ...
                                                            <div class="card-body p-0 scroll1 treehght">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <template v-else>
                                                                        <TreeItem
                                                                        class="item"
                                                                        :search="naics_code.search"
                                                                        :item="treeData"
                                                                        :tdr_naics="alert.naics"
                                                                        :clear_all_naics="clear_all_naics"
                                                                        :naics_codes="naics_code.naics_codes"
                                                                        >
                                                                        </TreeItem>
                                                                    </template>
                                                                    </ul>
        ...
        getNaics() {
            ...
            vm.$store
                ...
                .then(function (response) {
                    ...
                    vm.loading = false
                    if(!vm.naics_code.search){
                        vm.getPscs()
                    }
                    if(vm.alert.alert_id){
...
>>>>>>> 398cfda8168c8c0dd008c8351ff486428ba935fc
        ...
        clearAllNaics() {
            ...
            setTimeout(() => {
                ...
                this.$store.dispatch('setAllNaics', false)
        ...
        clearAllPsc() {
            ...
            setTimeout(() => {
                ...
                this.$store.dispatch('setAllPscs', false)
