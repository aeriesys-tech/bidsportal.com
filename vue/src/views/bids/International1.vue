                ...
                <div class="col-md-5 my-auto">
                    <ul class="list-inline hstack flex-wrap gap-4 mb-0 s-dropdown dropdown my-auto" style="float: right;">
                        <li class="list-inline-item mb-0" v-if="tags?.length">
                            <a href="javascript:void(0)" class="" style="color: #747579;" @click.prevent="showModal()"><i class="fa fa-save fa-fw fs-6 cursor-pointer text-primary me-1"></i>Save View</a>
                        </li>
                        ...
                        <form class="rounded-3 shadow" id="federal">
                            <div class="card card1 card-body rounded-0 p-3">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#status" role="button" aria-expanded="false" aria-controls="status">
                                    <h6 style="font-size: 15px; font-weight: 500;" class="mb-2" :class="{bluetextclass: meta.statuses?.length}">Status</h6>
                            ...
                            <div class="card card1 card-body rounded-0 p-3">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#setaside" role="button" aria-expanded="false" aria-controls="notice">
                                    <h6 style="font-size: 15px; font-weight: 500;" class="mb-2" :class="{'bluetextclass': meta.set_asides?.length !==0}">Competition(Set-Aside)</h6>
                                            ...
                                            <table class="table small align-middle p-4 mb-0 table-hover table-shrink">
                                                <thead class="table-light">
                                                    <tr class="vertical-align-top">
                                                        ...
                                                        <th scope="col" class="padding-12-16">Bid number & <br>notice type</th>
                                                        <th scope="col" class="padding-12-16">Title</th>
                                                        <th scope="col" class="padding-12-16">Agency</th>
                                                        <th scope="col" class="padding-12-16">Place of <br>performance</th>
                                                ...
                                                <tbody class="border-top-0" v-for="federal_tender in federal_tenders" :key="federal_tender.federal_tender_id">
                                                    <tr>
                                                        ...
                                                        <td class="padding-16"><div v-html="highlight(federal_tender.title)"></div></td>
                                                        <td class="padding-16">{{ federal_tender.federal_agency?.agency_name }}</td>
                                                        <td class="padding-16">{{ federal_tender.place_of_performance }}</td>
                                                        <td class="padding-16" style="width: 110px;">{{ federal_tender.expiry_date }}</td>
                                                        <td class="padding-16">
    ...
    export default {
        ...
        methods: {
            ...
            tenderDetails(federal_tender){
                localStorage.setItem("bidsdetails", JSON.stringify(federal_tender))
                this.$store.commit("setSearchFilter", this.searchfilter);
                this.$store.commit("setCurrentPage", this.meta.currentPage);
                window.open("http://localhost:8080/#/bids/" + "federal-opportunities" + "/" + federal_tender.title.replace(/\//g, "") + "-" + federal_tender.tender_no, '_blank');
            },
