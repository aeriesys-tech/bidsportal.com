                        ...
                        <div class="text-end pb-2" v-if="federal_tenders.length">
                            <ul class="list-inline mb-0 z-index-2 small">
                                ...
                                <li class="list-inline-item" v-if="$store.getters.user !== null">
                                    <a href="javascript:void(0)" @click.prevent="emailmodalpop()"
                                ...
                                <div class="card shadow mb-3" v-for="federal_tender in federal_tenders"
                                    ...
                                    <div class="card-body py-md-3 d-flex flex-column h-100 position-relative"
                                        ...
                                        <ul class="nav nav-divider mt-3" style="color: #646c9a;">
                                            ...
                                            <li class="nav-item"><img class="small w-15px me-1"
                                                    src="../../assets/icons/posteddate.svg" />{{
                                                        dateFormat(federal_tender.posted_date) }}
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <ul class="nav nav-divider small mt-3" style="color: #595d6e;">
                                                    ...
                                                    <li class="nav-item"
                                                        v-if="federal_tender.place_of_performance != ''">
                                            ...
                                            <div class="mt-3">
                                                <ul class="list-inline mb-0 z-index-2 small">
                                                    <li class="list-inline-item" v-if="$store.getters.user !== null">
                                                        <a href="javascript:void(0)"
                                                            @click.prevent="shareTender(federal_tender)"
                                                            v-modal="shareBid.bids" class="p-2"><i
                                                                class="fa-solid fa-fw fa-share-alt"></i>SHARE </a>
                                                    </li>

                                                    <li class="list-inline-item"
                                                        v-if="checkCartItem(federal_tender.federal_tender_id)">
                                                        <div v-if="$store.getters.user?.subscription_id === 0">
                                                            <a href="javascript:void(0)"
                                                                @click="addCart(federal_tender)" class="p-2">
                                                                <img v-if="hidecartstatue"
                                                                    src="assets/images/addcart.svg" width="19" />
                                                            </a>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="padding-16">
                                                            <span
                                                                ...
                                                                <div v-if="$store.getters.user?.subscription_id === 0">
                                                                    <a href="javascript:void(0)"
                                                                        @click="addCart(federal_tender)"><img
                                                                            v-if="hidecartstatue" class="mb-1 me-2"
                                                                            src="@/assets/icons/addcart.svg"
                                                                            width="20" /></a>
                                                                </div>
                                                            </span>
                                                            <span v-else>
                                    ...
                                    <form class="card-body" style="min-width: 350px;">
                                        <div class="mb-3">
                                            <input class="form-control" :class="{ 'is-invalid': errors.mails }"
                                                ...
                                                type="text" id="recipient-name" v-model="mails" ref="mails" />
                                        ...
                                        <div class="mb-3">
                                            <input class="form-control" type="text" name="email_subject"
                                                ...
                                                autocomplet="off" id="email_subject" v-model="shareBid.subject"
                                                ref="subject" />
                                        ...
                                        <div class="mb-3">
                                            <textarea class="form-control" rows="3" name="email_message"
                                                ...
                                                v-model="shareBid.message"></textarea>
