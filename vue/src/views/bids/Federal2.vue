    ...
    export default {
        ...
        methods: {
            ...
            getStates() {
                let vm = this;
                if(vm.$store.getters.set_asides?.length && !this.isMoreThan24Hours()){
                    vm.states = vm.$store.getters.set_asides
                    vm.sorted_states = vm.states
                } else{
                    let uri = "getStates";
                    vm.$store
                        ...
                        .then(function (response) {
                            ...
                            vm.sorted_states = vm.states
                            vm.$store.dispatch('setStates', response.data)  
                        })
                        .catch(function (error) {
                            vm.errors = error.response.data.errors;
                            vm.$store.dispatch("error", error.response.data.message);
            ...
            getFederalAgencies() {
                let vm = this
                if(vm.$store.getters.federal_agencies?.length && !this.isMoreThan24Hours()){
                    ...
                    vm.$store
                        ...
                        .then(function (response) {
                            ...
                            vm.sorted_federal_agencies = vm.federal_agencies
                            vm.$store.dispatch('setFederalAgencies', response.data)
                        })
                        .catch(function (error) {
                            vm.errors = error.response.data.errors;
                            vm.$store.dispatch("error", error.response.data.message);
