                                ...
                                <span class="">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-sm btn-primary" @click="backSaveAlert()"
                                        style="padding: 5px; font-weight: 400;">Back</a> -->
                                          ...
                                          <router-link to="/bids/state-opportunities" class="btn fw-400 btn-sm btn-outline-dark me-2"
                                       >Back To Bids</router-link>
                                    <a href="javascript:void(0)" class="btn fw-400 btn-sm btn-success" @click="backSaveAlert()"
                                       >Back</a>
                                </span>
                            </div>
                            <div class="card-body">
