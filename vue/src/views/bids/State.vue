                ...
                <div class="col-md-4 my-auto">
                    <form class="bg-body shadow rounded-2">
                        <div class="input-group input-group-sm">
                            <vue3-tags-input class="form-control form-control-sm p-0 tag-center scrollinput" @on-tags-changed="handleChangeTag" placeholder="Input keywords separated by comma" v-model:tags="tags" :add-tag-on-keys="[13,188]" v-model="tag" @allow-duplicates="false" style="text-wrap: nowrap;"/>
                    ...
                    <ul class="list-inline hstack flex-wrap gap-4 mb-0 s-dropdown dropdown my-auto" style="float: right;">
                        ...
                        <li class="cursor list-inline-item mb-0 s-dropdown dropdown hover1 mb-0 dropdown-toggle" href="#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="s-dropdown-content dropdown-menu dphover" style="max-height: 200px; overflow-y: scroll;" aria-labelledby="demoMenu">
                                <li v-for="state_filter, key in state_filters" :key="key" class="dropdown-item dropitem1 p-0 px-2">
                                    <i class="fas fa-caret-right text-primary my-auto"></i>
                                    <a class="dropdown-item dropitem2" href="javascript:void(0)" @click="showStateFilter(state_filter)">{{ state_filter.state_filter_name }}</a>
                        ...
                        <form class="rounded-3 shadow" id="federal">
                            <div class="card card-body rounded-0 p-2">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#status" role="button" aria-expanded="false" aria-controls="status">
                                    <h6 style="font-size: 15px; font-weight: normal;" class="mb-2" :class="{bluetextclass: meta.statuses?.length}">Status</h6>
                            ...
                            <div class="card card-body rounded-0 p-2">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="noticetype" v-for="notice in state_notices" :key="notice.notice_id">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                            ...
                            <div class="card card-body rounded-0 p-2">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="federalagency">
                                    ...
                                    <div class="scroll3">
                                        <div class="d-flex justify-content-between align-items-center" v-for="state in sorted_state_agencies" :key="state.state_agency_id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" :value="state.state_agency_id" v-model="meta.state_agencies" />
                    ...
                    <div class="vl-parent">
                                    ...
                                    <div class="card-body py-md-2 d-flex flex-column h-100 position-relative" id="hovershadow">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <strong class="card-title mb-1">
                                                <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                    <a href="javascript:void(0)" @click="tenderDetails(state_tender)" style="text-transform: uppercase;"><div v-html="highlight(state_tender.title)"></div></a>
                                                </div>
                                                <div v-else>
                                            ...
                                            <ul class="list-inline mb-0 z-index-2">
                                                <li class="list-inline-item">
                                                    <div class="form-check-inline mb-0" v-if="$store.getters.user !==null">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" :value="state_tender.state_tender_id" id="flexCheckChecked" v-model="sendMails.bids" />
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <ul class="list-group list-group-borderless small mb-0 mt-2">
                                            <li class="list-group-item d-flex text-success p-0">
                                                <p class="limited-text" style="color: #595d6e; text-align: justify;" v-html="state_tender.description" v-if="state_tender.description!='0' && state_tender.description!='-'"></p>
                                            </li>
                                        </ul>
                                            ...
                                            <table class="table table-sm small align-middle p-4 mb-0 table-hover table-shrink">
                                                ...
                                                <tbody class="border-top-0" v-for="state_tender in state_tenders" :key="state_tender.state_tender_id">
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="form-check my-auto" v-if="$store.getters.user !==null">
                                                                    <input class="form-check-input me-3" type="checkbox" :value="state_tender.state_tender_id" v-model="sendMails.bids" />
                                                                </div>

                                                                <div class="row">
                                                                    <div class="column">
                                                                        <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                                            <a href="javascript:void(0)" @click="tenderDetails(state_tender)">{{ state_tender.tender_no }}</a>
                                                                        </div>
                                                        ...
                                                        <td>{{ state_tender.state_agency?.agency_name }}</td>
                        ...
                        <div v-if="state_tenders.length !== 0">
                            <div style="float: left;">
                                <input type="text" class="form-control" v-model="meta.page" @keypress.enter="getStateTenders()" style="width: 60px;" />
                            </div>
            ...
            <div class="">
                <div class="">
                    ...
                    <div class="">
                        ...
                        <SaveSearch @closeModal="closeModal" @savedSearch="saveSearch" @updateSearch="addStateFilter" :status="status" :alert_label="meta.alert_label" :savedbids="savedbids" ref="save_search" v-if="save_search" />
                    </div>
                </div>
