                        ...
                        <form class="rounded-3 shadow" id="federal">
                            ...
                            <div class="card card1 card-body rounded-0 p-3">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center"
                                    ...
                                    <h6 style="font-size: 15px; font-weight: 500;" class="mb-2"
                                        :class="{ 'bluetextclass': meta.privates?.length !== 0 }">Categories</h6>
                                    <a class="p-0 mb-0">
                                        <i class="fa-solid fa-angle-down ms-2"></i>
                                    </a>
                                </div>
                            ...
                            <div class="card card1 card-body rounded-0 p-3">
                                <div class="ml2 d-flex btn-more collapsed d-flex justify-content-between align-items-center"
                                    ...
                                    aria-controls="notice">
                                    <h6 style="font-size: 15px; font-weight: 500;" class="mb-2"
                                        :class="{ 'bluetextclass': meta.privates?.length !== 0 }">Location (Place of
                                        Performance)</h6>
                                    <a class="p-0 mb-0">
                                        <i class="fa-solid fa-angle-down ms-2"></i>
                                    </a>
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="location">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="mb-1">
                                            <a class="btn btn-link p-0 mb-0 me-2">({{ meta.privates.length }} of {{
                                                privates.length }})</a>
                                            <span v-if="meta.privates.length !== sorted_privates.length"> <a href=""
                                                    @click.prevent="selectAllPrivates()"
                                                    class="form-check-label text-primary me-2">| Select All</a></span>
                                            <span v-if="meta.privates.length">
                                                <a href="" class="form-check-label text-primary me-2"
                                                    @click.prevent="deselectAllPrivates()">| Reset</a>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form class="position-relative w-100 me-4 mb-2">
                                            <input class="form-control form-control-sm bg-light pe-5" type="search"
                                                @keyup="searchPrivates()" v-model="private_keyword"
                                    ...
                                    <div class="scroll1">
                                        <!-- <div class="d-flex justify-content-between align-items-center"
                                            v-for="private in sorted_privates" :key="private.private_id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    :value="private.private_id" v-model="meta.privates" />
                                                <label class="form-check-label"> {{ private.private_name }}</label>
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                            ...
                            <div class="card card1 card-body rounded-0 p-3">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="federalagency">
                                    ...
                                    <div class="scroll3">
                                        <!-- <div class="d-flex justify-content-between align-items-center"
                                            v-for="private in sorted_private_agencies" :key="private.private_agency_id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    :value="private.private_agency_id"
                                                    v-model="meta.private_agencies" />
                                                <label class="form-check-label"> {{ private.private_agency_name
                                                    }}</label>
                                            </div>
                                        </div> -->
                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="column">
                                                                    ...
                                                                    <div v-else><a href="javascript:void(0)"
                                                                            @click="showModal()">{{
                                                                                private_tender.tender_no }}</a></div>
                                                                </div>
                                    ...
                                    <form class="card-body" style="min-width: 350px;">
                                        <div class="mb-3">
                                            <input class="form-control" :class="{ 'is-invalid': errors.mails }"
                                                ...
                                                v-model="share_private_tender.recipient_email" ref="mails" />
...
export default {
    ...
    watch: {
        ...
        "meta.privates": "triggerPrivateTenders",
    ...
    methods: {
        ...
        showPrivateFilter(private_filter) {
            ...
            this.meta.privates = private_filter.privates;
        ...
        tenderDetails(private_tender) {
            // console.log("private--", private_tender.tender_no)
            this.$store.commit("setPrivateTender", private_tender)
            this.$store.commit("setFilters", this.meta)
            this.$router.push("private-opportunities-new/" + private_tender.title.replace(/ /g, "-") + "-" + private_tender.tender_no)
        },
        ...
        searchPrivates() {
            let vm = this;
            vm.sorted_privates = vm.privates.filter(function (element) {
                return element.private_name.toLowerCase().includes(vm.private_keyword.toLowerCase());
            });
        },
        selectAllPrivates() {
            let vm = this;
            vm.meta.privates = [];
            vm.sorted_privates.map(function (element) {
                vm.meta.privates.push(element.private_id);
            });
        },
        deselectAllPrivates() {
            let vm = this;
            vm.meta.privates = [];
            vm.sorted_privates = vm.privates;
            vm.private_keyword = null;
        },
        ...
        applyFilters() {
            ...
            const meta_fields = [
                ...
                { meta_field: "privates", data_field: "privates", id_field: "private_id", name_field: "private_name" },
        ...
        getPrivateNotices() {
            ...
            vm.$store
                ...
                .then(function (response) {
                    vm.private_notices = response.data;
                    vm.getCategories();
                })
                .catch(function (error) {
                    vm.errors = error.response.data.errors;
        ...
        getPrivateAgencies() {
            ...
            vm.$store
                ...
                .then(function (response) {
                    vm.private_agencies = response.data;
                    vm.sorted_private_agencies = vm.private_agencies;
                    if (vm.$store.getters.user) {
