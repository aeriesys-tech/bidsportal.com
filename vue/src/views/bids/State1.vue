    ...
    <div class="regions">
        <div class="container-fluid justify-content-center pt-3">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li class="nav-item">
                    <router-link to="/bids/state-opportunities" class="nav-link active">
            ...
            <div class="row g-2 g-lg-4">
                        ...
                        <form class="rounded-3 shadow">
                            ...
                            <div class="card card-body rounded-0 p-2">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show mb-3" id="posted">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="group2" id="hour6" v-model="searchfilter.posted_date" value="24 Hours" @click="hidedate()" @change="changePostedDate('24 Hours')" />
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="hour7" name="group2" v-model="searchfilter.posted_date" value="2 Days" @click="hidedate()" @change="changePostedDate('2 Days')" />
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="hour8" name="group2" v-model="searchfilter.posted_date" value="7 Days" @click="hidedate()" @change="changePostedDate('7 Days')" />
                                            <label class="form-check-label" for="hour8">7 Days</label>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="hour9" name="group2" v-model="searchfilter.posted_date" value="21 Days" @click="hidedate()" @change="changePostedDate('21 Days')" />
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="">
                                            ...
                                            <div class="row" v-if="searchfilter.posted_date=='custom'" style="margin-left: 0px !important;">
                                                <div class="col-sm-6">
                            ...
                            <div class="card card-body rounded-0 p-2">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="categorys">
                                    ...
                                    <div class="scroll1" style="height: 300px !important;">
                            ...
                            <div class="card card-body rounded-0 p-2">
                                ...
                                <div class="col-12 ml2 multi-collapse collapse show" id="Private">
                                    ...
                                    <div class="scroll1" style="height: 300px !important;">
                                        <div class="d-flex justify-content-between align-items-center" v-for="statefederal in  agencyState " :key="statefederal.id">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" :value="statefederal.agency_name" v-model="selectedState" @change="updateCheckallState(statefederal)" :id="statefederal.id + 'statefederal'" />
                                                <label class="form-check-label" :for="statefederal.id + 'statefederal'"> {{ statefederal.agency_name }}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="vl-parent">
                        ...
                        <section v-if="StateOppotunities.length === 0">
                            <div class="container">
                        ...
                        <div class="text-end" v-if="StateOppotunities.length !== 0">
                        ...
                        <div>
                            <div v-if="listview">
                                <div class="card shadow mb-2" v-for="StateOppotunitie in StateOppotunities" :key="StateOppotunitie.tdr_id">
                                    <div class="card-body py-md-2 d-flex flex-column h-100 position-relative" id="hovershadow">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <strong class="card-title mb-1">
                                                <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                    <a href="javascript:vodi(0)" @click="bidsdetails(StateOppotunitie)" style="text-transform: uppercase;"><div v-html="highlight(StateOppotunitie.tdr_title)"></div></a>
                                                </div>
                                                <div v-else>
                                                    <a href="javascript:void(0)" @click="showModal()">
                                                        <div v-html="highlight(StateOppotunitie.tdr_title)"></div>
                                                    </a>
                                                </div>
                                            </strong>
                                            <ul class="list-inline mb-0 z-index-2">
                                                <li class="list-inline-item" v-if="$store.getters.user !== null">
                                                    <div class="form-check-inline mb-0">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" :value="StateOppotunitie.tdr_id" id="flexCheckChecked" v-model="sendMails.bids" />
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <ul class="nav nav-divider mt-3" style="color: #646c9a;">
                                            <li class="nav-item"><img class="small w-15px me-1" src="../../assets/icons/posteddate.svg" />{{ StateOppotunitie?.notice?.notice_type }}</li>
                                            <li class="nav-item"><img class="small w-15px me-1" src="../../assets/icons/bidnumber.svg" />{{ StateOppotunitie.tdr_no }}</li>
                                            <li class="nav-item">
                                                <img class="small w-15px me-1" src="../../assets/icons/posteddate.svg" />{{ dateFormat(StateOppotunitie.tdr_posted_date) }} &nbsp;<span>{{StateOppotunitie.created_at }} </span>
                                            </li>
                                            <li class="nav-item">
                                                <img class="small w-15px me-1" src="../../assets/icons/duedate.svg" /> {{ dateFormat(StateOppotunitie.tdr_expiry_date) }}
                                                <span class="col-green" v-if=" datecalcu(StateOppotunitie.tdr_expiry_date,currentDate()) >= 1">
                                                    &nbsp; {{ datecalcu( StateOppotunitie.tdr_expiry_date, currentDate() ) }} Day to Go
                                                </span>
                                        ...
                                        <ul class="list-group list-group-borderless small mb-0 mt-2">
                                            <li class="list-group-item d-flex text-success p-0">
                                                <p class="limited-text" style="color: #595d6e; text-align: justify;" v-html="StateOppotunitie.tdr_desc"></p>
                                            </li>
                                        </ul>
                                        <div class="border-top d-sm-flex justify-content-sm-between align-items-center mt-3 mt-md-auto">
                                            <div class="d-flex align-items-center">
                                                <ul class="nav nav-divider small mt-3" style="color: #595d6e;">
                                                    <li class="nav-item text-primary"><i class="bi bi-patch-check-fill text-primary me-2"></i>{{ StateOppotunitie.tdr_agency}}</li>
                                                    <li class="nav-item">
                                                        <i class="bi bi-geo-alt-fill text-primary me-2"></i>{{ StateOppotunitie?.state?.state_name }}<span v-if="StateOppotunitie?.state?.state_name">,</span> {{
                                                        StateOppotunitie?.country?.country_name }}
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="mt-3">
                                                <ul class="list-inline mb-0 z-index-2 small">
                                                    <li class="list-inline-item" v-if="$store.getters.user !== null">
                                                        <a href="javascript:void(0)" class="p-2" @click.prevent="shareBidstate(StateOppotunitie)" v-modal="shareBid.bids"><i class="fa-solid fa-fw fa-share-alt"></i>SHARE</a>
                                                    </li>
                                                    <li class="list-inline-item" v-if="checkCartItem(StateOppotunitie.tdr_id)">
                                                        <div v-if="$store.getters.user?.subscription_id ===0">
                                                            <a href="javascript:void(0)" @click="addCart(StateOppotunitie)" class="p-2">
                            ...
                            <div v-else>
                                <div class="card shadow" v-if="StateOppotunities.length !== 0">
                                    <div class="card-body py-md-2 d-flex flex-column h-100 position-relative">
                                        <div class="table-responsive border-0">
                                            <table class="table table-sm small align-middle p-4 mb-0 table-hover table-shrink">
                                                ...
                                                <tbody class="border-top-0" v-for="StateOppotunitie in StateOppotunities" :key="StateOppotunitie.tdr_id">
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="form-check my-auto" v-if="$store.getters.user !==null">
                                                                    <input class="form-check-input me-3" type="checkbox" :value="StateOppotunitie.tdr_id" v-model="sendMails.bids" />
                                                                </div>

                                                                <div class="row">
                                                                    <div class="column">
                                                                        <div v-if="$store.getters.user !==null && $store.getters.user.subscription_id !==0">
                                                                            <a href="javascript:vodi(0)" @click="bidsdetails(StateOppotunitie)">{{ StateOppotunitie.tdr_no }}</a>
                                                                        </div>
                                                                        <div v-else>{{ StateOppotunitie.tdr_no }}</div>
                                                                    </div>

                                                                    <div class="column">
                                                                        <a :style="{color:StateOppotunitie.notice.backround_color}" class="badge bg-success bg-opacity-10">{{ StateOppotunitie.notice.notice_type }}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>{{ StateOppotunitie.tdr_title }}</td>
                                                        <td>{{ StateOppotunitie.tdr_agency }}</td>
                                                        <td>{{ StateOppotunitie.state.state_code }},{{ StateOppotunitie?.state?.state_name }}</td>
                                                        <td style="width: 110px;">{{ StateOppotunitie.tdr_expiry_date }}</td>
                                                        <td>
                                                            <span v-if="checkCartItem(StateOppotunitie.tdr_id)">
                                                                <div v-if="$store.getters.user?.subscription_id ===0">
                                                                    <a href="javascript:void(0)" @click="addCart(StateOppotunitie)"><img v-if="hidecartstatue" class="mb-1 me-2" src="@/assets/icons/addcart.svg" width="20" /></a>
                                                                </div>
                                                            </span>
                                                            <span v-else>
                                                                <img src="assets/images/icons/cart-24.svg" width="19" />
                        ...
                        <div v-if="StateOppotunities.length !== 0">
                            <div style="float: left;">
                                <input type="text" class="form-control" v-model="meta.currentPage" @keypress.enter="getstatebids()" style="width: 60px;" />
                            </div>
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter(to, from, next) {
            next((vm) => {
                //  console.log(vm.$store.getters.alert.set_aside_status)
                if (to.query.region_id == "1") {
                ...
                //    vm.$store.dispatch('setAlert', null);
                //    vm.clearAllFilters();
        ...
        methods: {
            ...
            getIndex() {
                ...
                let uri = "searchBidsForStateOppotunities?page=" + vm.meta.currentPage + "&search=" + vm.meta.search + "&order_by=" + vm.meta.order_by + "&field=" + vm.meta.field + "&per_page=" + vm.meta.per_page;
                vm.isLoading = true;
                vm.$store
                    .dispatch("post", { uri: uri, data: vm.searchfilter })
                    .then(function (response) {
                        vm.isLoading = false;
                        vm.StateOppotunities = response.data.data;
                        console.log(vm.StateOppotunities)
            ...
            getcategory() {
                ...
                vm.$store
                    ...
                    .then(function (response) {
                        ...
                        if (vm.searchfilter.tdr_category) vm.appendCategoryToFilter(vm.searchfilter.tdr_category);
                    })
                    .catch(function (error) {
                        vm.errors = error.response.data.errors;
                        vm.$store.dispatch("error", error.response.data.message);
            ...
            addAlert(alert) {
                ...
                vm.savealert.state_fedral = vm.searchfilter.tdr_agency.toString();
            ...
            updateSearch(savedbids) {
                let vm = this;
                vm.savedserach.id = savedbids.id;
                vm.savesearch.alert_label = savedbids.alert_label;
                vm.savesearch.user_id = vm.$store.getters.user.id;
                vm.savesearch.notice_type = vm.searchfilter.tdr_notice.toString();
                vm.savesearch.category_id = vm.searchfilter.tdr_category.toString();
            ...
            runSearch(savedbids) {
                ...
                vm.appendTenderAgencyToFilter(vm.searchfilter.tdr_agency);
                vm.getstatebids();
            },
            ...
            appendTenderAgencyToFilter(agencies) {
                let vm = this;
                if (Array.isArray(agencies)) {
                    agencies.map(function (element) {
                        let agency_obj = vm.agencyState.filter(function (ele) {
                            return ele.agency_id == element;
                        });
                        if (agency_obj.length) {
                            vm.filters.push({
                                table: "state",
                                id: agency_obj[0].agency_id,
                                name: agency_obj[0].agency_name,
                            });
                        }
                    });
                } else {
                    let agency_obj = vm.agencyState.filter(function (ele) {
                        return ele.agency_id == agencies;
                    });
                    if (agency_obj.length) {
                        vm.filters.push({
                            table: "state",
            ...
            removeTagnotice(filter) {
                ...
                let Agency = this.searchfilter.tdr_category.findIndex((data) => data === filter.id);

                if (Agency !== -1) {
                    this.searchfilter.tdr_category.splice(Agency, 1);
                }
            ...
            shareBidstate(federal) {
                let vm = this;
                vm.errors = [];
                vm.shareBid.bids = [];
                vm.shareBid.mails = [];
                vm.shareBid.bids.push(federal.tdr_id);
                if (vm.$store.getters.user.subscription_id == 0) {
                    vm.alertSubscribe = true;
