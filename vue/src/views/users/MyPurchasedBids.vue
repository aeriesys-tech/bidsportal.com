                                        ...
                                        <div class="">
                                            <div class="d-flex align-items-center">
                                                <div class="" style="padding: 7px;">
                                                    ...
                                                    <h6>Order ID : <span style="font-weight: normal;">{{userpayment?.order_id}} </span> <span style="font-weight: normal;"> |</span> Dated : <span style="font-weight: normal;">{{format_date(userpayment?.payment_date)}}</span></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
