                        ...
                        <div class="col-12 d-flex justify-content-md-between ">
                            ...
                            <button class="mybutton-secondary mybutton-success" @click.prevent="interstedmodalpop()"><i class="fa-solid fa-user-plus m-1"></i>Add Interest</button>
                                ...
                                <li class="list-inline-item" v-if="federal_tender?.notice_id">
                                    <button class="btn btn-sm btn-success" @click="openWebSite()"><i
                                            class="fa-solid fa-globe m-1"></i>Open Website</button>
                                </li>
                                <li class="list-inline-item" v-else>
                                    <button class="btn btn-sm btn-success" @click="showAlert()"><i
                                            class="fa-solid fa-globe m-1"></i>Open Website</button>
                                </li>

                                <li class="list-inline-item" v-if="$store.getters.user">
                                    <button class="btn btn-sm btn-primary" @click.prevent="sharefederal_tenders()"><i
                            ...
                            <div class="d-md-flex justify-content-md-between">
                                <div>
                                    <p class="" style="color: black; font-size: 18px;">
                                        <img v-if="federal_tender.region?.region_id == 2" class="icon"
                                            src="/img/federalblue.6e218214.svg" alt="icon" />
                                        <img class="icon" v-if="federal_tender.region?.region_id == 1"
                                            src="/img/stateblue.16cfab6e.svg" alt="icon" />
                                        <img class="icon" v-if="federal_tender.region?.region_id == 3"
                                            src="/img/privateblue.c4518422.svg" alt="icon" />
                                        <img class="icon" v-if="federal_tender.region?.region_id == 4"
                                    ...
                                    <ul class="nav nav-divider text-body mb-0">
                                        <li class="nav-item"><span
                                                ...
                                                :</span>&nbsp;{{ federal_tender.tender_no }}</li>
                                        <li class="nav-item"><img class="mb-1" src="assets/icons/posteddate.svg"
                                                width="17" /> Last Updated on
                                            {{ format_date(federal_tender.posted_date) }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="d-sm-flex justify-content-sm-between align-items-center mb-3">
                                                ...
                                                <div v-if="federal_tender.federal_office_address">
                                                    ...
                                                    <p>
                                                        {{ federal_tender.federal_office_address.city }}<span
                                                            v-if="federal_tender.federal_office_address.city">, </span>
                                                        <span>{{ federal_tender.federal_office_address.state +
                                                            '' + federal_tender.federal_office_address.country }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body py-0 p-4">
                                            <div class="row g-3 align-items-center justify-content-between mb-3">
                                                <div class="col-md-6"
                                                    v-if="federal_tender?.federal_attachments?.length">
                                                    <strong class="text-primary">Downloads ({{
                                                        federal_tender?.federal_attachments?.length }})</strong>
                                                </div>
                                            ...
                                            <div class="table-responsive border-2 border-radius">
                                                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                                                    ...
                                                    <tbody class="border-top-0">
                                                        ...
                                                        <tr v-for="federal_attachment, att_key in federal_tender.federal_attachments"
                                                            :key="att_key">
                                                            <td class="text-center">
                                                                <i :class="federal_attachment.attachment_icon"
                                                            ...
                                                            <td class="text-center"
                                                                v-if="federal_attachment.download_url">
                                                                <a :href="federal_attachment.download_url"
                                            ...
                                            <div class="p-3" style="margin-bottom: 5px; border: 1px solid #dfdfe3;"
                                                ...
                                                <div class="d-sm-flex justify-content-between">
                                                    <div class="d-sm-flex align-items-center mb-3">
                                                        <div>
                                                            <h6 class="m-0 mb-2">
                                                                {{ bidintersed.user_details.company_name }}</h6>
                                                            <span class="me-3">User Name : {{
                                                                bidintersed.user_details.name }}</span><br />

                                                            <span class="me-3">Position : {{
                                                                bidintersed.bid_interested_type }}</span><br />
                                                            <span class="me-3">Website : {{
                                                                bidintersed.user_details.web_address }}</span><br />
                                        ...
                                        <ul class="list-group list-group-borderless border-top-0 mb-0">
                                            <li class="list-group-item">
                                                ...
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    federal_tender.federal_notice?.notice_name }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                    Posted Date</div>
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    format_date(federal_tender.posted_date) }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                    Response Date</div>
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    format_date(federal_tender.expiry_date) }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div>
                                                    <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                            ...
                                            <li class="list-group-item">
                                                <div>
                                                    <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                        PSC Code</div>
                                                    <div class="mb-0" style="color: #747579; font-size: 16px;">
                                                        {{ federal_tender.psc?.psc_code }}-{{
                                                            federal_tender.psc?.psc_description
                                                        }}</div>
                                                </div>
                                            </li>
                                            <li class="list-group-item">
                                                <div>
                                                    <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                        NAICS Code</div>
                                                    <div class="mb-0" style="color: #747579; font-size: 16px;">
                                                        {{ federal_tender.naics?.naics_code }}-{{
                                                            federal_tender.naics?.naics_description }}</div>
                                                </div>
                                            </li>
                                            <li class="list-group-item">
                                                <div
                                                    v-if="federal_tender.tender_type && federal_tender.tender_type != 25 && federal_tender.region?.region_id == 2">
                                                    <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                        Contract Type</div>
                                                    <div class="mb-0" style="color: #747579; font-size: 16px;">
                                ...
                                <div class="col-md-6 col-xl-12" v-if="federal_tender.federal_contacts?.length">
                                    <div class="card card-body border bg-light p-4">
                                        ...
                                        <div v-for="federal_contact, key in federal_tender.federal_contacts" :key="key">
                                            <strong class="mb-1 " v-if="federal_contact.type == 0">Primary
                                                Contact:</strong>
                                            <strong class="mb-1 " v-if="federal_contact.type == 1">Secondary
                                                Contact:</strong>
                                            <ul lass="list-group list-group-borderless"
                                                ...
                                                <li class="list-group-item py-1" v-if="federal_contact.fullName">
                                                    <span class="text-info fw-light me -1 mb-0">{{
                                                        federal_contact.full_name }}</span>
                                                </li>
                            ...
                            <form class="card-body" style="min-width: 350px;">
                                <div class="mb-3">
                                    <input class="form-control" placeholder="Employee/Colleague Email Address"
                                        autocomplet="off" type="text" id="recipient-name" v-model="mails" ref="mails" />
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center p-3">
                                <div class="d-flex align-items-center">
                                    <div class="ms-2">
                                        <h6 class="mb-0 title-green fw-500">Add Interest</h6>
                                    </div>
                                </div>
                                <a href="#" class="btn btn-sm btn-link p-0 mb-0"><button type="button"
                                        @click.prevent="closemodal()" class="btn-close"></button></a>
                            ...
                            <form class="card-body">
                                <div class="form-check form-check-md mb-2">
                                    <a href="javascript:vodi(0)"
                                        class="btn btn-success-soft btn-round flex-shrink-0 ms-2 mb-0"><i
                                            class="fab fa-codepen"></i> </a>
