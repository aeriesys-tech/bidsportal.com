                        ...
                        <div class="col-12 d-flex justify-content-md-between">
                            ...
                            <ul class="list-inline text-end">
                                ...
                                <li class="list-inline-item" v-if="$store.getters.user">
                                    <button class="btn btn-sm btn-primary" @click.prevent="shareprivate_tenders()"><i
                            ...
                            <div class="d-md-flex justify-content-md-between">
                                <div>
                                    <p class="" style="color: black; font-size: 18px;">
                                        <img v-if="private_tender.region?.region_id == 2" class="icon"
                                            src="/img/federalblue.6e218214.svg" alt="icon" />
                                        <img class="icon" v-if="private_tender.region?.region_id == 1"
                                            src="/img/stateblue.16cfab6e.svg" alt="icon" />
                                        <img class="icon" v-if="private_tender.region?.region_id == 3"
                                    ...
                                    <ul class="nav nav-divider text-body mb-0">
                                        <li class="nav-item"><span
                                                ...
                                                :</span>&nbsp;{{ private_tender.tender_no }}</li>
                                        <li class="nav-item"><img class="mb-1" src="assets/icons/posteddate.svg"
                                                width="17" />
                                            Last Updated on {{ format_date(private_tender.posted_date) }}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <ul class="list-group list-group-borderless mb-3">
                                                <li class="list-group-item">
                                                    ...
                                                    <span class="fw-light mb-0">{{
                                                        private_tender.private_agency?.agency_name }}</span>
                                                </li>
                                            </ul>
                                                        ...
                                                        <tr v-for="private_attachment, att_key in private_tender.private_attachments"
                                                            ...
                                                            <td id="demo-3" :title="private_attachment.attachment_name">
                                                                <span class="truncated-text">{{
                                                                    private_attachment.attachment_name }}</span>
                                                            </td>
                                                            <td>{{ private_attachment.attachment_size
                                                                }}</td>
                                                            <td>{{ private_attachment.attachment_date
                                                                }}</td>
                                                            <td class="text-center"
                                                                v-if="private_attachment.attachment_url">
                                                                <a :href="private_attachment.attachment_url"
                                        ...
                                        <ul class="list-group list-group-borderless border-top-0 mb-0">
                                            <li class="list-group-item">
                                                ...
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    private_tender.private_notice?.notice_name }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                    Posted Date
                                                ...
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    format_date(private_tender.posted_date) }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                    Response Date
                                                ...
                                                <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                    format_date(private_tender.expiry_date) }}</div>
                                            </li>
                                            <li class="list-group-item">
                                                <div>
                                                    <div class="h6 fw-light mb-0" style="font-weight: 500 !important;">
                                                    ...
                                                    <div class="mb-0" style="color: #747579; font-size: 16px;">{{
                                                        private_tender.category?.category_name }}</div>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="card border card-body border bg-light p-4">
                                        ...
                                        <div v-for="private_contact, key in private_tender.private_contacts" :key="key">
                                            <strong class="mb-1 text-primary"
                                                v-if="private_contact.type == 'Primary'">Primary
                                                Contact:</strong>
                                            <strong class="mb-1 text-primary"
                                                v-if="private_contact.type == 'Secondary'">Secondary
                                                Contact:</strong>
...
export default {
    ...
    methods: {
        ...
        checkContact() {
            if (this.private_tender?.tdr_pri_fullname !== "" || this.private_tender?.tdr_pri_phone !== "" || this.private_tender?.tdr_pri_email !== "" || this.private_tender?.tdr_sec_phone !== "" || this.private_tender?.tdr_sec_email !== "") {
                return true;
            }
        },
        interstedmodalpop() {
