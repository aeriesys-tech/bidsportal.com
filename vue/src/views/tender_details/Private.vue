                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="d-md-flex justify-content-md-between">
                                <div>
                                    <h5 style="color: #5143d9; font-size: 18px; margin-bottom: 3px; font-weight: 500;" class="nav-item">{{ private_tender.title }}</h5>
    ...
    <teleport to="#modals" v-if="erroralertmodal">
        <div class="modal-overlay">
            <div class="confirm" style="background-color: white !important;">
                ...
                <button style="color: red !important; background-color: white !important;" @click.prevent="deletePrivateInterest(deleteduser)">Confirm</button>
            </div>
        </div>
    </teleport>
</template>
