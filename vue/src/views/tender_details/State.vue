                    ...
                    <div class="d-md-flex justify-content-md-between">
                        <div>
                            <p class="" style="color: black; font-size: 18px;">
                                <img v-if="state_tender.region?.region_id ==2" class="icon" src="/img/federalblue.6e218214.svg" alt="icon" />
                                <img class="icon" v-if="state_tender.region?.region_id ==1" src="/img/stateblue.16cfab6e.svg" alt="icon" />
                                <img class="icon" v-if="state_tender.region?.region_id ==3" src="/img/privateblue.c4518422.svg" alt="icon" />
                                <img class="icon" v-if="state_tender.region?.region_id ==4" src="/img/internationalblue.2bdbd466.svg" alt="icon" />
                                State & Local Opportunities
                            </p>
                            <h5 style="color: #5143d9; font-size: 18px; margin-bottom: 3px; font-weight: 700;" class="nav-item">{{state_tender.tdr_title}}</h5>
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-borderless mb-3">
                                        <li class="list-group-item">
                                            ...
                                            <span class="fw-light mb-0">{{state_tender.state_agency?.agency_name}}</span>
                                        </li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-xl-12" v-if="state_tender.state_contacts?.length">
                            <div class="card card-body border bg-transparent">
                                ...
                                <div v-for="state_contact, key in state_tender.state_contacts" :key="key">
                                    <strong class="mb-1 text-primary" v-if="state_contact.type=='Primary'">Primary Contact:</strong>
                                    <strong class="mb-1 text-primary" v-if="state_contact.type=='Secondary'">Secondary Contact:</strong>
                                    <ul lass="list-group list-group-borderless" style="border-top: none;">
                                        <li class="list-group-item py-1" v-if="state_contact.fullName">
                                            <span class="text-info fw-light me -1 mb-0">{{ state_contact.full_name }}</span>
                                        </li>
